...
// ============================================================
//  고정 해외법인 목록
//  '당월 예상매출' 시트 '명칭'열 감지와 무관하게
//  항상 해외법인으로 분류할 거래처를 여기에 추가하세요.
//
//  형식: { '법인 표시명': ['거래처명1', '거래처명2', ...] }
//  → 메뉴 2 해외법인수출 집계, 메뉴 3 해외법인 행에 반영됩니다.
// ============================================================
export const OVERSEAS_FIXED = {
  '인도네시아법인': ['PT SINAR KECANTIKAN INDONESIA'],
}
